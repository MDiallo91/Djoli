...
export async function switchSchoolDatabase(userId: string) {
    ...
    runExec("CREATE TABLE IF NOT EXISTS composition_schedules (id TEXT PRIMARY KEY, name TEXT NOT NULL, term TEXT, school_year_id TEXT, created_at TEXT DEFAULT CURRENT_TIMESTAMP, updated_at TEXT DEFAULT CURRENT_TIMESTAMP, deleted_at TEXT);");
    runExec("CREATE TABLE IF NOT EXISTS composition_schedule_entries (id TEXT PRIMARY KEY, schedule_id TEXT NOT NULL, subject_id TEXT, day_of_week TEXT, start_time TEXT, end_time TEXT, class_ids TEXT DEFAULT '[]', notes TEXT, created_at TEXT DEFAULT CURRENT_TIMESTAMP, updated_at TEXT DEFAULT CURRENT_TIMESTAMP, deleted_at TEXT);");
